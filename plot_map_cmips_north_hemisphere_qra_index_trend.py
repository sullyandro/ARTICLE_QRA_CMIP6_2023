	...
	for subexp in subex:
		...
		for trend in ['ens-all', 'ens-10-lower', 'ens-10-upper']:
			...
			for time_period in ['2015-2050', '2051-2100']:
				...
				dir_in_trend = '../data/{0}/trend_analysis'.format(exp)
				...
				figname  = '{0}/map_{1}_{3}_Amon_{4}_{2}_{5}_{6}-{7}_2p5dg_jja_regress.png'.format(dir_ou_figs, exp, subexp, 'tas', trend, 'r1i1p1', yr1, yr2)
