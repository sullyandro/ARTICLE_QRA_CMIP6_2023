...
for exp in ['era-interim', 'cmip5', 'cmip6']:
	...
	for subexp in subex:
		...
		for var in ['tas', 'ua']:
			...
			dir_ou = '../data/{0}/{1}/{2}_2p5dg_jja_zonmean_timmean-{3}-{4}'.format(exp, subexp, var, yr1, yr2)
			...
			for fin in files:
				...
				fou = fin.replace('_2p5dg_jja_zonmean', '_2p5dg_jja_zonmean_timmean-{}-{}'.format(yr1,yr2))
