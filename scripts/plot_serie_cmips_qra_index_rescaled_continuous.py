...
for exp in ['cmip5', 'cmip6']:
    ...
    for subexp in subex:
        ...
        dir_in = '../data/{0}/{1}/{2}_2p5dg_jja_zonmean_lat-25n-75n_QRAindex_continuous_rescaled-{3}'.format(exp, subexp, var, RESCALE_PERIOD)
...
figname = '../figures/plot_serie_cmip5_historical_rcp85_QRAindex_1850-2100_rescaled-{0}_continuous.png'.format(RESCALE_PERIOD)

fig, ax = plt.subplots(figsize=(12,9))

plt.grid(color='grey', linestyle='--', linewidth=0.3, alpha=0.5)

plt.title('QRA Index from TAS (rescaled by ERA5 and GISTEMP)\nCMIP5 Historical and RCP85')
...
figname = '../figures/plot_serie_cmip6_historical_ssp585_QRAindex_1850-2100_rescaled-{0}_continuous.png'.format(RESCALE_PERIOD)
...
figname = '../figures/plot_serie_cmip6_historical_ssp370_QRAindex_1850-2100_rescaled-{0}_continuous.png'.format(RESCALE_PERIOD)
...
figname = '../figures/plot_serie_cmip6_historical_ssp370-lowNTCF_QRAindex_1850-2100_rescaled-{0}_continuous.png'.format(RESCALE_PERIOD)
...
for i,a in enumerate(data_all_cmip6_ssp370_lowntcf.keys()):
	if 'ENSEMBLE-MEAN' not in a:  ax.plot(data_tim_cmip6_ssp370, data_all_cmip6_ssp370_lowntcf     [a][lim_c6_ssp370], '-', color='gray', lw=1, label='{1}_{2}_{0}'.format(*a.split('_')) )
...
ax.plot(data_tim_cmip6_ssp370, data_ens_cmip6_ssp370_lowntcf     [lim_c6_ssp370], '-', color='black', lw=3, label='CMIP6 ENSEMBLE MEAN SSP370-lowNTCF')
...
figname = '../figures/plot_serie_cmip5_cmip6_historical_rcp_ssp_QRAindex_1850-2100_rescaled-{0}_continuous_EDITED.png'.format(RESCALE_PERIOD)
...
plt.axvline(x=2005, ymin=0.1, ymax=0.95, color='gray', alpha=0.7, linestyle='--', lw=0.7)
plt.axvline(x=2014, ymin=0.1, ymax=0.95, color='gray', alpha=0.7, linestyle='--', lw=0.7)
plt.text(2004, 2.7, str(2005), color="gray", fontsize=8, rotation=90, alpha=0.7)
plt.text(2013, 2.7, str(2014), color="gray", fontsize=8, rotation=90, alpha=0.7)
...
figname = '../figures/plot_serie_cmip5_cmip6_historical_rcp_ssp_QRAindex_1850-2100_rescaled-{0}_continuous_EDITED_with_SSP370-lowNTCF.png'.format(RESCALE_PERIOD)
