...
for exp in ['cmip5', 'cmip6']:
    ...
    for subexp in subex:
        ...
        for i,a in enumerate(files):
            ...
            dat = np.nanmean( np.squeeze(ds['tas'].data), axis=1)
...
figname = '../figures/plot_serie_cmip5_historical_rcp85_anom_1850-2100_continuous.png'

fig, ax = plt.subplots(figsize=(12,9))

plt.grid(color='grey', linestyle='--', linewidth=0.3, alpha=0.5)

plt.title('TAS Anomaly - CMIP5 Historical and RCP85\nJJA mean - Zonal mean (25N-75N)')
plt.ylabel('Temperature anomaly [°C]')

plt.axvline(x=2005, ymin=0.1, ymax=0.95, color='gray', alpha=0.7, linestyle='--', lw=0.7)
plt.text(2004, -1.4, str(2005), color="gray", fontsize=8, rotation=90, alpha=0.7)
...
figname = '../figures/plot_serie_cmip6_historical_ssp585_anom_1850-2100_continuous.png'

fig, ax = plt.subplots(figsize=(12,9))

plt.grid(color='grey', linestyle='--', linewidth=0.3, alpha=0.5)

plt.title('TAS Anomaly - CMIP6 Historical and SSP585\nJJA mean - Zonal mean (25N-75N)')
plt.ylabel('Temperature anomaly [°C]')

plt.axvline(x=2014, ymin=0.1, ymax=0.95, color='gray', alpha=0.7, linestyle='--', lw=0.7)
plt.text(2013, -1.4, str(2014), color="gray", fontsize=8, rotation=90, alpha=0.7)
...
figname = '../figures/plot_serie_cmip6_historical_ssp370_anom_1850-2100_continuous.png'

fig, ax = plt.subplots(figsize=(12,9))

plt.grid(color='grey', linestyle='--', linewidth=0.3, alpha=0.5)

plt.title('TAS Anomaly - CMIP6 Historical and SSP370\nJJA mean - Zonal mean (25N-75N)')
plt.ylabel('Temperature anomaly [°C]')
...
figname = '../figures/plot_serie_cmip6_historical_ssp370-lowNTCF_anom_1850-2100_continuous.png'

fig, ax = plt.subplots(figsize=(12,9))

plt.grid(color='grey', linestyle='--', linewidth=0.3, alpha=0.5)

plt.title('TAS Anomaly - CMIP6 Historical and SSP370-lowNTCF\nJJA mean - Zonal mean (25N-75N)')
plt.ylabel('Temperature anomaly [°C]')
...
figname = '../figures/plot_serie_cmip5_cmip6_historical_rcp_ssp_anom_1850-2100_continuous.png'

fig, ax = plt.subplots(figsize=(12,8))

plt.grid(color='grey', linestyle='--', linewidth=0.3, alpha=0.5)

plt.title('TAS Anomaly - CMIP5 and CMIP6\nJJA mean - Zonal mean (25N-75N)')
plt.ylabel('Temperature anomaly [°C]')

plt.axvline(x=2005, ymin=0.1, ymax=0.95, color='gray', alpha=0.7, linestyle='--', lw=0.7)
plt.axvline(x=2014, ymin=0.1, ymax=0.95, color='gray', alpha=0.7, linestyle='--', lw=0.7)
plt.text(2004, -0.6, str(2005), color="gray", fontsize=8, rotation=90, alpha=0.7)
plt.text(2013, -0.6, str(2014), color="gray", fontsize=8, rotation=90, alpha=0.7)
...
figname = '../figures/plot_serie_cmip5_cmip6_historical_rcp_ssp_anom_1850-2100_with_SSP370-lowNTCF_continuous.png'
